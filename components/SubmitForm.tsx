...
export default function SubmitForm() {
    ...
    if (submitted) {
        return (<div className="rounded-2xl bg-teal-50 border border-teal-100 p-8 text-center">
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
      ...
      <button type="submit" disabled={isSubmitting} className="btn-primary w-full py-4 text-base disabled:opacity-60">
