...
export default async function CityPage() {
  ...
  const faqLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How many pain management doctor are in Houston, TX?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Pain Management Doctor Directory lists 35+ pain management doctor in Houston, Texas. Counts change as new listings are seeded.",
        },
      },
      {
        "@type": "Question",
        name: "How do I find pain management doctor in Houston?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Search findpainmanagement.com and filter by Houston. Compare listed providers, then contact the one that fits.",
        },
      },
    ],
  }
    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight">
          Pain Management Doctor in Houston, TX
        </h1>
        <p className="mt-3 max-w-2xl text-neutral-600">
          35+ listed pain management doctor in the Houston area. Pages are generated from live directory listings — not outreach.
        </p>
